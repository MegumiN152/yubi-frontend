...
import {deleteTeamUsingPost, listTeamUsingPost, updateTeamUsingPost} from "@/services/yubi/teamController";
import {listAllUsersUsingGet} from "@/services/yubi/userController";
...
const TeamManage: React.FC = () => {
  ...
  const loadData = async () => {
    setLoading(true);
    try {
      const res : any = await listTeamUsingPost(searchParams);
      if (res.data) {
